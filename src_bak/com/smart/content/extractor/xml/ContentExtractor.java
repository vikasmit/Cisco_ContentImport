...
public class ContentExtractor {
	...
	public boolean parseAndWriteXML(HashMap<String, String> attributeMap,
		...
		//System.out.println(">>>>>>>>"+parserFileLocation+fileName);
		try {
						...
						if (null != node) {
							...
							if (attributeMap.containsKey((attKey + "_TYPE"))
								...
								for (int j = 0; null != nodeList
									...
									if (nod!=null && nod.getNodeType() == Node.ELEMENT_NODE && nod.getFirstChild()!=null){
										System.out.println(nod);
										System.out.println(nod.getFirstChild());
