...
public class ContentExtractor {
	...
	public boolean parseAndWriteXML(HashMap<String, String> attributeMap,
		...
		try {
			...
			Document xmlDocument = builder.parse(file, "UTF-8");
		...
		//	File flname;
			...
			//	flname = new File(parserExportFileLocation
				//		+ ContentConstant.TEMPXML_FILE_NAME_PREFIX
				 ...
				 out = new OutputStreamWriter(new FileOutputStream(parserExportFileLocation+ ContentConstant.TEMPXML_FILE_NAME_PREFIX+ 
						 filenamewithoutextn + "_" + increment + ".xml"), "UTF-8");
				
			} else {
			/*	flname = new File(parserExportFileLocation
						+ ContentConstant.TEMPXML_FILE_NAME_PREFIX
						+ filenamewithoutextn + ".xml");*/
				out = new OutputStreamWriter(new FileOutputStream(parserExportFileLocation
						+ ContentConstant.TEMPXML_FILE_NAME_PREFIX
						+ filenamewithoutextn + ".xml"), "UTF-8");
			}
